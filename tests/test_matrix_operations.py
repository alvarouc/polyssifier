...
def test_exponent_matrix():
    ...
    assert (matrix == exponent_matrix(matrix, 1)).all()
    assert (matrix_2pow == exponent_matrix(matrix, 2)).all()
    assert (matrix_3pow == exponent_matrix(matrix, 3)).all()
    assert (matrix_4pow == exponent_matrix(matrix, 4)).all()
...
def test_create_multivariate():
    ...
    assert (poly1 == create_multivariate(matrix, 1)).all()
    assert (poly2 == create_multivariate(matrix, 2)).all()
    assert (poly3 == create_multivariate(matrix, 3)).all()